...
- When the `error` event is fired when closing the sender/recevier link, surface errors occuring on the sender/receiver context if none are found on the session context. Details can be found in [PR #55](https://github.com/amqp/rhea-promise/pull/55)
